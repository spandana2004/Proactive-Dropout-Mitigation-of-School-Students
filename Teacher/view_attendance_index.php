...
<body>
    ...
    <form action="attendance_view.php" method="post" class="attendance-form">
    
        <div class="form-group">
            <label for="dateInput">Date:</label>
            <input type="date" name="attendance_date" id="dateInput" value="<?= $attendance_date ?>" required>
        </div>

        <button type="submit" class="submit-button"><font color="white">View Attendence</button></font>
    </form>
