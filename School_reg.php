...
<form  action="Connection1.php" method="post"  onsubmit="return validateForm() " enctype="multipart/form-data">
<div class="input-box">
<span class="icon">
...
<div class="select">
<label for="select"><b>Category:</b></label>
<select id="category"  name="category" required>  
    <option value="select">Select</option> 
    <option value="Private">Private</option> 
 <option value="Government Aided">Government Aided</option> 
    <option value="Government">Government</option>
    <option value="Tribal">Tribal School</option>
    <option value="Others">Others</option>
    </select></div>
<br>
<font color="red">(optional)*</font>
<br><label for="logo"><b>Enter Logo:</b></label>
<br><br>
<div class="img">
<input type="file" name="logo" id="logo" accept="image/*" style="cursor: pointer;">
</div>
<br><br>
<div class="input box">
    <label>
...
<div class="input box">
<label><input type="checkbox" id="agreeCheckbox" required>I agree to all <font color="blue"><a href="TermsNCond.php">Terms and Conditions</a></font></u></label><br></div>
<br>
<br>
...
function validateForm() {
    ...
    var s1 = document.getElementById("inputState").value;
    ...
    if (s2 === "select") {
        alert("Please select the school category.");
        return false;
    }
...
alert("Registered Successfully!!");
    ...
    setTimeout(function () {
        window.location.href = "School_log.php";
    }, 3500);
