...
<link rel="stylesheet" href="style_tcr.css">
</head>
<style>
#preloader{
...
<form  action="Connection3.php" method="post" onsubmit="return validateForm() " enctype="multipart/form-data">
<label><font size=3.5 color="#76D7C4">Aadhaar Number</font></label>
<div class="input-box">
    <span class="icon">
        <ion-icon name="person"></ion-icon>
    </span>
    <input type="text" id="aadhaar" name="aadhaar" value="<?php echo isset($_GET['adhaarNumber']) ? $_GET['adhaarNumber'] : ''; ?>" readonly>
</div>
<div class="input-box">
<span class="icon">
...
<br><label for="image"><b>Choose Photo:</b></label>
<br><br>
<div class="img">
<input type="file" name="image" id="image" accept="image/*" style="cursor: pointer;" required>
</div>
<br><br>
<div class="input box">
