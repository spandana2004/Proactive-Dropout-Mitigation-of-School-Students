...
<head>
    ...
    <script>
        // AJAX function to fetch classes from the database
        function getClasses() {
            var xhr = new XMLHttpRequest();
            xhr.onreadystatechange = function () {
                if (xhr.readyState == 4 && xhr.status == 200) {
                    var classes = JSON.parse(xhr.responseText);
                    updateClassesDropdown(classes);
                }
            };
        ...
        // AJAX function to fetch sections based on the selected class
        function getSections(selectedClass) {
            var xhr = new XMLHttpRequest();
            xhr.onreadystatechange = function () {
                if (xhr.readyState == 4 && xhr.status == 200) {
                    var sections = JSON.parse(xhr.responseText);
                    updateSectionsDropdown(sections);
                }
            };
            xhr.open("GET", "get.php?class=" + selectedClass, true);
            xhr.send();
        }

        // Function to update the classes dropdown
...
<body>
    ...
    <button class="back-button" onclick="goBack()">
        ...
        <div class="options-slider">
            <div class="option"><img src="dash2.png" alt="Option Image"> <a href="">Dashboard</a></div>
            <div class="option">
        <img src="att1.png" alt="Option Image">
        <a href="view_class.php">Attendance Report</a>
    </div>
    <div class="option"><img src="log1.png" alt="Option Image"><a href="logout.php">Logout</a></div>
    ...
    <div class="background-page">
        ...
        <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
            ...
            <select id="class" name="class" onchange="getSections(this.value)">
