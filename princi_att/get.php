Create a file name get.php(if you don’t have it) and paste the below code
...
$dbname = "sih"; // Replace with your database name
...
$sql = "SELECT DISTINCT `Section` FROM `attendance` WHERE `Class` = '$selectedClass'";
